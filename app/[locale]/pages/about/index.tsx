...
export const AboutSection = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center bg-gray-100 dark:bg-[#141414] w-full sm:h-[35rem] h-full px-10 sm:px-0 pt-10 sm:pt-0 pb-10 sm:pb-0">
            <h1 className="text-2xl sm:text-3xl font-bold text-emerald-600 dark:text-white">{t("title")}</h1>
            ...
            <a href="https://drive.google.com/file/d/1dtjg3OqsIEZbdQkwatU7UUkEHZgdFt1b/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
